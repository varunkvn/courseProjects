...
<form method="post" action="<%=response.encodeURL("fthree.jsp")%>">
<pre>
   2. which one of the following is not a oracle tool
   <input type="radio" name="ftwo" value="a">sql*plus
   <input type="radio" name="ftwo" value="b">forms
   <input type="radio" name="ftwo" value="c">reports
   <input type="radio" name="ftwo" value="d">layout editor
</pre>
