...
<form  method="post" action="<%=response.encodeURL("ffour.jsp")%>">

<pre>
   3. DDL stands for
   <input type="radio" name="fthree" value="a">Data Definition Language
   <input type="radio" name="fthree" value="b">Data Down Language
   <input type="radio" name="fthree" value="c">Ding Dong Language
   <input type="radio" name="fthree" value="d">Dilwale Dulhania lejayange
</pre>
