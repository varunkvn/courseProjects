...
<form  method="post" action="<%=response.encodeURL("jfive.jsp")%>">

<pre>
   4.Output of java compiler is 
   <input type="radio" name="ffour" value="a">bit code
   <input type="radio" name="ffour" value="b">byte code
   <input type="radio" name="ffour" value="c">no code
   <input type="radio" name="ffour" value="d">no java
</pre>
