...
<form  method="post" action="<%=response.encodeURL("result.jsp")%>">

<pre>
   5. select sal from emp where sal>1500
   <input type="radio" name="ffive" value="a">1500
   <input type="radio" name="ffive" value="b">1000
   <input type="radio" name="ffive" value="c">2000
   <input type="radio" name="ffive" value="d">none
</pre>
