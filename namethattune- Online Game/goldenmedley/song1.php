...
<?php $start_description = "In the Golden Medley Showdown, you've got to name 7 songs in 30 seconds! Each of the songs is from a different decade. The timer is running only while the song is playing. Clicking on \"Name That Tune\" will stop the clock and allow you to type your answer on the screen. If you're not sure – click \"Pass\" or \"Play\" the next song. It's you against the clock! Starting with the 1950's – NAME THAT TUNE!"; ?>
      ...
      <table cellspacing="0">
      	<tbody>
        	<tr>
            	<th colspan="5">
                <?php  if( $_GET['gid'] == '1'){ ?>
    <script >  var soundfile = "music/Golden Medley Showdown/GMS  Intro.mp3"; </script>
	<span id="gameInstructionAudio"></span> <!-- Game ko first song ko suruma instruction audio yehi bata play huncha  -->

<div id="auto_hide_after_desc" class="display-song-wrapper">
<div id="start_description"> 
 <p> <?php echo htmlentities($start_description); ?>
 </p>
</div>
</div>


    <div id="description_homepage_gm" class="display-song-wrapper"  style="display:none; ">
           <p> <?php echo htmlentities($start_description); ?>   </p> 
...
<?php } ?>
                    ...
                    <span id="countdown_msg"  style="display:none; font-weight:normal; ">Count Down will start right after the song</span>
    ...
    <fieldset>
    <input type="text" onFocus="clearAnswerMsg('1');" onMouseOver="clearAnswerMsg('1');" id="youranswer1" name="youranswer1" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer1').click()"> 
    ...
    <div id="answer_image2"  style="display:none;" class="answer_image"  >  </div> 
     ...
     <fieldset>
<input type="text" onFocus="clearAnswerMsg('2');" onMouseOver="clearAnswerMsg('2');" id="youranswer2" name="youranswer2" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer2').click()">
    ...
    <fieldset>
<input type="text" onFocus="clearAnswerMsg('3');" onMouseOver="clearAnswerMsg('3');" id="youranswer3" name="youranswer3" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer3').click()">
    ...
    <fieldset>
<input type="text" onFocus="clearAnswerMsg('4');" onMouseOver="clearAnswerMsg('4');" id="youranswer4" name="youranswer4" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer4').click()">
    ...
    <td><a href="javascript: void(0);"  id="revealanswerbutton4" style="display:none;"  onclick=" playReveal('4', 'music/Golden Medley Showdown/GMS-4 Livin On A Prayer/GMS-4 80s Answer.mp3');"> Reveal Answer  </a> &nbsp; &nbsp;</td>
       ...
       <fieldset>
 <input type="text" onFocus="clearAnswerMsg('5');" onMouseOver="clearAnswerMsg('5');" id="youranswer5" name="youranswer5" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer5').click()">
       ...
       <fieldset>
 <input type="text" onFocus="clearAnswerMsg('6');" onMouseOver="clearAnswerMsg('6');" id="youranswer6" name="youranswer6" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer6').click()">
     ...
     <tr>
    <td><span id="decade7"> 2010's</span></td> 
   ...
   <div id="youranswer7_msg" name="youranswer7_msg"> </div>  
    <fieldset>
<input type="text" onFocus="clearAnswerMsg('7');" onMouseOver="clearAnswerMsg('7');" id="youranswer7" name="youranswer7" value=""  style="display:none"  onkeydown="if (event.keyCode == 13) document.getElementById('submitanswer7').click()">
    ...
    <td> <a href="javascript: void(0);"    id="passthatbutton7" class="disable"    onclick="cdpause(), clickAndDisableBoth('7',this), playSong('8','music/Golden Medley Showdown/GMS-7 Need You Now/need you now (clip).mp3');"> Pass </a>  &nbsp; &nbsp;<!--pass garda next song bajna paryo -->  </td>
...
<a href="javascript: void(0);" id="viewoverallscore" style="display:none;" onclick="gotoOverallScorePage(<?php echo $i; ?>,'goldenmedley');">  View Overall Score </a> &nbsp; &nbsp;

<a href="javascript: void(0);" id="nextanswerbutton" style="display:none;" onclick="nextSong(<?php echo $i; ?>,'goldenmedley');">  Back to All Games </a> &nbsp; &nbsp;
