...
<?php include ('ringbell/answer_script_rb.php') ?>


<div id="mainbody">
<div class="startareaplay">
            <h1>Ring That Bell</h1>
...
<?php  if( $_GET['gid'] == '1'){ ?>
    ...
    <script >  var soundfile = "music/Ring That Bell/RTB  Intro.mp3";  </script>
...
<ul class="tune-rt-btn">
   <li>  <a href="javascript: void(0);" id="revealanswerbutton"  class="disable"   onclick="revealAnswer(),        playReveal('<?php echo $play_reveal1; ?>','<?php echo $play_reveal2; ?>');">      Reveal Answer  </a>  </li> 
     &nbsp; &nbsp;</li>
    <li><a href="javascript: void(0);" id="nextanswerbutton" class="disable" onclick="nextSong(<?php echo $i; ?>,'ringbell');">  Next </a> &nbsp; &nbsp;</li>
</ul>
</div>
