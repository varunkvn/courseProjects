...
public class Updatedata extends javax.swing.JFrame {
	...
	public Updatedata(String route, String name, String from, String to,
       ...
       txtDistance.addKeyListener(new KeyAdapter() {
		...
		public void actionPerformed(ActionEvent e) {
			  if (txtRouteNo.getText() == null ||
                ...
                JOptionPane.showMessageDialog(null,"Enter route number","tobiluoch",
                JOptionPane.DEFAULT_OPTION);
				...
				try
                     {
                       if ( !txtRouteNo.equals("") )
                       {
                          ...
                          //{
                          	JOptionPane.showMessageDialog(null,"Enter route number to search","tobiluoch",
                            JOptionPane.DEFAULT_OPTION);
                            return;
                          //}
                     }
