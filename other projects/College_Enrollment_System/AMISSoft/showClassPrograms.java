...
public class showClassPrograms extends MESFrame implements ActionListener{

    MainFrame parent;
    MESTable table;
    JTextField keyMaster;
    public showClassPrograms(MainFrame main)
    {
    	super(700,300,"",new String[] {"Locate Record","Print","Class Schedules","Register Students","Close"}  );
    ...
    public void actionPerformed(ActionEvent event )
    {
        ...
        else if(act.equals("Class Schedules"))
        {
        parent.addFrame5(new StudentSchedule(parent,this));
        }
        else if(act.equals("Register"))
        {
           if(table.getTable().getSelectedRow()!=-1)
           {
           	...
           	parent.addFrame(new ClassProgramChecking(parent,this,table.getValueAtSelectedRow(0),table.getValueAtSelectedRow(1),table.getValueAtSelectedRow(2),table.getValueAtSelectedRow(3),table.getValueAtSelectedRow(4),table.getValueAtSelectedRow(5),table.getValueAtSelectedRow(6),table.getValueAtSelectedRow(7),table.getValueAtSelectedRow(8),table.getValueAtSelectedRow(9),table.getValueAtSelectedRow(10) ) );
           }  	
        }
        else if(act.equals("Register Students"))
        {
        	if(table.getTable().getSelectedRow()!=-1)
        	{
           	parent.addFrame(new ClassProgramChecking(parent,this,table.getValueAtSelectedRow(0),table.getValueAtSelectedRow(1),table.getValueAtSelectedRow(2),table.getValueAtSelectedRow(3),table.getValueAtSelectedRow(4),table.getValueAtSelectedRow(5),table.getValueAtSelectedRow(6),table.getValueAtSelectedRow(7),table.getValueAtSelectedRow(8),table.getValueAtSelectedRow(9),table.getValueAtSelectedRow(10) ) );
