...
public class ClassProgramChecking_Archieves extends MESFrame implements ActionListener{

    MainFrame parent;
    
    showClassPrograms_Archieves showclassprograms;
    ...
    public ClassProgramChecking_Archieves(MainFrame main ,showClassPrograms_Archieves paramshowPrograms, String IDCode,String FNameCode,String LNameCode,String LecID,String LabID,String daysID,String timeID,String roomID,String limitID,String instructorID,String CourseID){
...
//                  cntrRow=questionTable.getTableModel(); 
  ...
  public void actionPerformed(ActionEvent event){
        ...
        if(act.equals("Close"))
        {
         ...
         {
         parent.addFrame4(new enlist_students_to_subject_archieves(parent, this));
         }  
 ...
 void OnPrint()
   ...
   private class Printing implements Printable
   {
    ...
    //   g2d.drawString(strTotalSubjects,130,540);
