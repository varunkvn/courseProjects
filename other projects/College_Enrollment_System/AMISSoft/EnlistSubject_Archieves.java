...
public class EnlistSubject_Archieves extends MESFrame implements ActionListener{

    MainFrame parent;
    EnrollmentChecking_Archieves eChecking;
    ...
    public EnlistSubject_Archieves(MainFrame main,EnrollmentChecking_Archieves paramECheck){
