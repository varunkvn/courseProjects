...
import java.awt.*;
public class roomlistner implements ActionListener
{
	...
	public roomlistner(Connection connection, roomtbl_model rm, JTextField branchId, JTextField branchAddress,JTextField ptotalunits,JTextField pField)
	    {
	...
	public void actionPerformed( ActionEvent e )
	{
		try {
     			...
     			String query = "SELECT RoomNo,Location,Capacity,Remarks FROM room_management WHERE RoomNo='"+BranchCode.getText()+"'";
