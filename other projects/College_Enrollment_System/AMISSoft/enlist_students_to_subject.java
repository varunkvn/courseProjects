...
public class enlist_students_to_subject extends MESFrame implements ActionListener{

    MainFrame parent;
    ClassProgramChecking CPChecking;
    ...
    public enlist_students_to_subject(MainFrame main,ClassProgramChecking cChecking){
    	...
    	try
    	  {
    	  	...
    	  	String query="SELECT IDNumber,FirstName,LastName,Address,Gender,YearLevel,Course FROM StudentMaster WHERE IDNumber='"+numberField.getText()+"'";
    ...
    return;
       ...
       if(intchk==JOptionPane.YES_OPTION)
       {
            ...
            String sql ="INSERT INTO classAttendance_data(ClassNo,IDNumber,FirstName,LastName,Address,Gender,YearLevel,Course)VALUES('"+CPChecking.strID+"','"+number+"','"+question+"','"+answer+"','"+address+"','"+gender+"','"+yearlevel+"','"+course+"')";
            ...
            if(update ==0)																																																								
            {
                ...
                h.put("Course",course);
                parent.getCollection("classAttendance_data").add(h);
            }
             else{
                return;
            }
