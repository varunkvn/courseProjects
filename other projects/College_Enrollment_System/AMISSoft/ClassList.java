...
public class ClassList extends MESFrame implements ActionListener{
...
//    Connection connection;  
    ...
    public ClassList(MainFrame main){
        super(390,300,"", new String[] {"Page Setup","Print","Exit Window"});
        parent = main;
        init();
        setTitle("Student Report by Course");
        setVisible(true);
    }
    void init(){
        ...
        JLabel t1=new JLabel("Student Report by Course");
        MAINPANEL.add(t1).setBounds(280,10,370,25);
        ...
        JLabel t4=new JLabel("Course Code");
        MAINPANEL.add(t4);
        ...
        JLabel t6=new JLabel("Curriculum ID");
 ...
 */
   //comboBoxListener
    ...
    try
		...
		statement=connection.createStatement();
	    model = new redefinedModel( connection ); 
		...
		resultsPane.setBounds(10, 160, 755, 165);
		 ...
		 cl = new classListener (connection, model, BranchCode,BranchAddress,TotalUnitsField,roomField);
         //dataList2.addItemListener ( bcl );
     //    finalRM.getList(BranchCode.getText());
         BranchCode.addActionListener(cl);
  }//=====end of constructor//
