...
public class StudentMaster_onLoad extends MESFrame implements ActionListener{

    MainFrame parent;
    showStudentList studList;
    String custno="",compname="";
    JTextField ID,FirstName,LastName,Address,Email,Father,Mother,Contact,imageField;
    JComboBox cboSY,cbReligion,cbCitizenship,cbCStatus,cbGender,cbCourse,cbYearLevel,cboSemester;
    ...
    public StudentMaster_onLoad(MainFrame main){

        super(390,300,"", new String[] {"Add","Save","Search","Edit","Cancel","Update","Close"});
        parent = main;
        init();
        setTitle("Student MasterFile");
        setVisible(true);
    }
    void init(){
    ...
    //    MAINPANEL.add(t1).setBounds(270,0,200,25);
      //  t1.setFont(new Font("Verdana",Font.BOLD,14));
        ...
        JLabel t33=new JLabel("Enrollment Date");
        MAINPANEL.add(t33).setBounds(485,20,180,23);
        ...
        MAINPANEL.add(MiddleName).setBounds(380,20,100,23);
        MAINPANEL.add(EnrollmentDate).setBounds(595,20,100,23);
    ...
    void save(){
       if(! complete()){
           ...
           try
            ...
            String sql = "INSERT INTO studentmaster(IDNumber,FirstName,LastName,Address,Email,Father,Mother,ParentsAddress,BirthDate,Religion,Gender,ContactNo,Citizenship,Status,Image,Course,YearLevel,ParentsContactNo,School1,Address1,Graduated1,School2,Address2,Graduated2,School3,Address3,Graduated3,Sem,SY,MI,DateEnrolled)VALUES('"+STUDID+"','"+fname+"','"+lname+"','"+address+"','"+email+"','"+father+"','"+mother+"','"+parentsaddress+"','"+birthdate+"','"+religion+"','"+gender+"','"+contact+"','"
            +citizenship+"','"+cstatus+"','"+image+"','"+course+"','"+yearlevel+"','"+parentscontactno+"','"+school1+"','"+address1+"','"+graduated1+"','"+school2+"','"+address2+"','"+graduated2+"','"+school3+"','"+address3+"','"+graduated3+"','"+semester+"','"+sy+"','"+MiddleName.getText()+"','"+EnrollmentDate.getText()+"')";
            ...
            if(update ==0)								
            {
                ...
                h.put("Sem",semester);
                h.put("SY",sy);
                parent.getCollection("studentmaster").add(h);
            }
          else
            {
            return;
    ...
    void searchRECORD()
    {
      ...
      try
        ...
        connection=DriverManager.getConnection(url,username,password);
        statement=connection.createStatement();
        String query="SELECT IDNumber,FirstName,LastName,Address,Email,Father,Mother,ParentsAddress,BirthDate,Religion,Gender,ContactNo,Citizenship,Status,Image,Course,YearLevel,ParentsContactNo,School1,Address1,Graduated1,School2,Address2,Graduated2,School3,Address3,Graduated3,Sem,SY,MI,DateEnrolled FROM StudentMaster WHERE IDNumber='"+srcKey+"' OR LastName='"+srcKey+"'";
        rs=statement.executeQuery(query);
       ...
       // ImageLabel.setIcon(new ImageIcon(imagename));      
        ...
        EnrollmentDate.setText(rs.getString(31)); 
    	...
    	try
    	  {
    	  	...
    	  	connection=DriverManager.getConnection(url,username,password);
    	  	statement=connection.createStatement();
          //String sql = "INSERT INTO StudentMaster(IDNumber,FirstName,LastName,Address,Email,Father,Mother,ParentsAddress,BirthDate,Religion,Gender,ContactNo,Citizenship,Status,Image,Course,YearLevel,ParentsContactNo,School1,Address1,Graduated1,School2,Address2,Graduated2,School3,Address3,Graduated3,Sem,SY)VALUES('"+STUDID+"','"+fname+"','"+lname+"','"+address+"','"+email+"','"+father+"','"+mother+"','"+parentsaddress+"','"+birthdate+"','"+religion+"','"+gender+"','"+contact+"','"
            String citizenship=cbCitizenship.getSelectedItem().toString();
            String cstatus=cbCStatus.getSelectedItem().toString();
            String image=imageField.getText();
            String course=cbCourse.getSelectedItem().toString();
            ...
            String graduated2=Graduated2.getText();
            String query="UPDATE StudentMaster SET FirstName='"+FirstName.getText()+"',LastName='"+LastName.getText()+"',Email='"+Email.getText()+"',Father='"+Father.getText()+"',Mother='"+Mother.getText()+"',ParentsAddress='"+ParentsAddress.getText()+"',BirthDate='"+BirthDate.getText()+"',Religion='"+religion+"',Gender='"+gender+"',ContactNo='"+Contact.getText()+"',Citizenship='"+citizenship+"',Status='"+cstatus+"',Image='"+image+"',Course='"+course+"',YearLevel='"+yearlevel+"',ParentsContactNo='"+parentscontactno+"',School1='"+School1.getText()+"',Address1='"+Address1.getText()+"',Graduated1='"+Graduated1.getText()+"',School2='"+School2.getText()+"',Address2='"+Address2.getText()+"',Graduated2='"+Graduated2.getText()+"',School3='"+School3.getText()+"',Address3='"+Address3.getText()+"',Graduated3='"+Graduated3.getText()+"' WHERE IDNumber='"+ID.getText()+"'";
