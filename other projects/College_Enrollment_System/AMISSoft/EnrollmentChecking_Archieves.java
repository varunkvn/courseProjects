...
public class EnrollmentChecking_Archieves extends MESFrame implements ActionListener
{
    ...
    MainFrame parent;
    showStudentList_Archieves showstudentlist;
    showClassPrograms_Archieves showCPrograms;
...
//    PageFormat landscape;
    ...
    public EnrollmentChecking_Archieves(MainFrame main ,showStudentList_Archieves paramstudentlist,String IDCode,String FNameCode,String LNameCode,String AddressCode,String GenderCode,String CourseCode,String YearLevelCode,String SemCode,String SYCode,String ErDateCode,String StatusCode)
    {
 ...
 public class clockHandler implements ActionListener{
    ...
    public void actionPerformed(ActionEvent event){
        ...
        if(act.equals("Close"))
        {
         ...
         {
         parent.addFrame4(new EnlistSubject_Archieves(parent, this));
         }  
