...
public class StudentMasterList extends MESFrame implements ActionListener{

    MainFrame parent;
    MESTable table;
    JTextField keyMaster;
    public StudentMasterList(MainFrame main)
    {
    ...
    void init()
    {
        ...
        table = new MESTable("",new String[] {"IDNumber","FirstName","LastName","Address","Gender","Course","Level","Sem","SY"});
        table.setColumnSize(new int[] {160,120,140,400,100,130,80,80,80});
        MAINPANEL.add(table);
    ...
    public void actionPerformed(ActionEvent event )
    {
        ...
        {
//        parent.addFrame(new StudentMaster(parent,this));
        }
