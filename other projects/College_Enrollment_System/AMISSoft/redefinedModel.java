...
public  class redefinedModel extends AbstractTableModel{
	String columnName[] = { "IDNumber","FirstName","LastName","Address","Gender","YearLevel" };
	Object value [][] = { { "...","...","...","...","...........","...","...","..."} };
	Connection connection;
	int totalRows;
	int totalPopulation;
	public redefinedModel ( Connection con ) {
		connection=con;
//		totalPopulation=pRows;
	...
	public void getList ( String branchCode) {
		try {
		    ...
		    String query="SELECT IDNumber,FirstName,LastName,Address,Gender,YearLevel FROM StudentMaster WHERE Course='"+branchCode+"'";
	...
	public int getTotalRows ( String branchCode ) {
		...
		try {
			Statement statement = connection.createStatement(); 
		    String query="SELECT count(*) FROM StudentMaster  WHERE Course='"+branchCode+"'";
		    ResultSet resultSet = statement.executeQuery ( query );
		    resultSet.next();
