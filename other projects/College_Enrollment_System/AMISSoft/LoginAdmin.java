...
package mes.gui;
  ...
  import mes.gui.*;
     ...
     public class LoginAdmin extends MESFrame implements ActionListener
     {
     MainFrame parent;
     IntroFrame intro;
    ...
    String password="rose";
     ...
     String chrs="Did you forget your password?.\n"
      ...
      public LoginAdmin(MainFrame main,IntroFrame introFrame)
      {
      super(300,170 ,"Login Administrator", new String[] {"Change Account","Login","Cancel"});
      setTitle("Login");
      parent=main;
      intro=introFrame;
      init();
      ...
      String action=e.getActionCommand();
	   ...
	   {
	   parent.addFrame3_part2(new ChangeUserID(parent,this));
	   setVisible(false);
	   }
	  }
      void logAdminStud()
