...
public class showStudentList_Archieves extends MESFrame implements ActionListener{

    MainFrame parent;
    MESTable table;
    JTextField keyMaster;
    public showStudentList_Archieves(MainFrame main)
    {
        super(700,300,"",new String[] {"Locate Record","Print","Student Enrollment File","Student MasterFile","Close"}  );
        setTitle("Student Master Archieves");
        parent = main;
        init();
        setVisible(true);
      } 
    ...
    void fillTable()
    {
        DataCollection col = parent.getCollection("temp");
    ...
    public void actionPerformed(ActionEvent event )
    {
        ...
        {
        parent.addFrame2(new StudentMaster_Archieves(parent,this));
        }
        else if(act.equals("Student Enrollment File"))
        {
           if(table.getTable().getSelectedRow()!=-1)
           {
           	parent.addFrame(new EnrollmentChecking_Archieves(parent,this,table.getValueAtSelectedRow(0),table.getValueAtSelectedRow(1),table.getValueAtSelectedRow(2),table.getValueAtSelectedRow(3),table.getValueAtSelectedRow(4),table.getValueAtSelectedRow(5),table.getValueAtSelectedRow(6),table.getValueAtSelectedRow(7),table.getValueAtSelectedRow(8),table.getValueAtSelectedRow(9),table.getValueAtSelectedRow(10) ) );
           }  	
        }
        else if(act.equals("Locate Record"))
        {
			...
			try {
	        	...
	        	ResultSet rs = parent.getResultSet3();
