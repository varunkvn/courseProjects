...
import java.io.*;
import java.sql.*;
public class FacultySearch1 extends HttpServlet
{
	Connection con;
	Statement stmt;
	ResultSet rs;
...
out.println("<br/><br/>");
out.println("Faculty Search");
out.println("<br/><br/>");
rs=stmt.executeQuery("select distinct(branch) from faculty");
...
rs=stmt.executeQuery("select distinct(year) from faculty");
...
rs=stmt.executeQuery("select distinct(semester) from faculty");
